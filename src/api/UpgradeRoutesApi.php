...
class UpgradeRoutesApi
{
     ...
     */
    public function getUpgradeByHeight($height)
    {
        $response = $this->getUpgradeByHeightWithHttpInfo($height);
        return $response;
    }
     ...
     */
    public function getUpgradeByHeightWithHttpInfo($height)
    {
        $returnType = '\Proximax\Model\CatapultConfigDTO';
        $request = $this->getUpgradeByHeightRequest($height);
    ...
    /**
     * Operation getUpgradeByHeightAsync
     *
     ...
     */
    public function getUpgradeByHeightAsync($height)
    {
        return $this->getUpgradeByHeightAsyncWithHttpInfo($height)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getUpgradeByHeightAsyncWithHttpInfo
     *
     * @param  string $height (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUpgradeByHeightAsyncWithHttpInfo($height)
    {
    ...
    /**
     * Create request for operation 'getUpgradeByHeight'
     *
     * @param  string $height (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getUpgradeByHeightRequest($height)
    {
        // verify the required parameter 'height' is set
        if ($height === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $height when calling getUpgradeByHeight'
            );
        }

        $resourcePath = '/upgrade/{height}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
