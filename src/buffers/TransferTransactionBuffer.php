...
class TransferTransactionBuffer extends Table
{
     ...
     * @return TransferTransactionBuffer
     */
    public static function createTransferTransactionBuffer(FlatBufferBuilder $builder, $size, $signature, $signer, $version, $type, $fee, $deadline, $recipient, $messageSize, $numMosaics, $message, $mosaics)
    {
        $builder->startObject(12);
