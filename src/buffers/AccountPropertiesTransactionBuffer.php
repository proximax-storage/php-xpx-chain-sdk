...
class AccountPropertiesTransactionBuffer extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AccountPropertiesTransactionBuffer
     */
    public static function getRootAsAccountPropertiesTransactionBuffer(ByteBuffer $bb)
    {
        $obj = new AccountPropertiesTransactionBuffer();
     ...
     * @return void
     */
    public static function startAccountPropertiesTransactionBuffer(FlatBufferBuilder $builder)
    {
     ...
     * @return AccountPropertiesTransactionBuffer
     */
    public static function createAccountPropertiesTransactionBuffer(FlatBufferBuilder $builder, $size, $signature, $signer, $version, $type, $maxFee, $deadline, $propertyType, $modificationCount, $modifications)
    {
        $builder->startObject(10);
        ...
        self::addPropertyType($builder, $propertyType);
        self::addModificationCount($builder, $modificationCount);
     ...
     * @return void
     */
    public static function addPropertyType(FlatBufferBuilder $builder, $propertyType)
    {
        $builder->addByteX(7, $propertyType, 0);
    }
     ...
     * @return void
     */
    public static function addModificationCount(FlatBufferBuilder $builder, $modificationCount)
    {
        $builder->addByteX(8, $modificationCount, 0);
    }
     ...
     */
    public static function endAccountPropertiesTransactionBuffer(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAccountPropertiesTransactionBufferBuffer(FlatBufferBuilder $builder, $offset)
    {
